...
export default function StudentDashboard() {
  ...
  const getIndustryStyle = (industry) => {
    switch (industry.toLowerCase()) {
      ...
      case 'content': return { icon: <PenTool />, color: 'yellow' };
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="relative flex-grow">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:outline-none transition-shadow"
                />
              </div>
