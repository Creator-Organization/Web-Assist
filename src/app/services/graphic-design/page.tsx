...
// Icons for graphic design
import { PenTool, Palette, Brush, ImageIcon, Layers, Sparkles } from 'lucide-react';

// SAME images you are using
import BesideGraphicImage from '../../../../Images/Beside_graphic_design.jpg';
      ...
      <section className="relative flex flex-col items-center justify-center text-center py-28 px-6 overflow-hidden">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-10">
            Powerful visuals crafted to elevate your brand identity through creativity, clarity, and impactful design.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto relative">
            ...
            >
              ...
              <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                Great design blends creativity with strategy. Our graphic design solutions ensure your visuals communicate clearly, attract attention, and strengthen your brand.
              </p>

              <p className="text-lg text-gray-700 leading-relaxed">
                From branding to digital content, our designers craft visually compelling artwork tailored to your business identity.
              </p>
            </motion.div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6 xl:px-16 max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            {[
              { icon: Palette, title: 'Brand Identity Design', desc: 'A cohesive brand system including colors, typography & style.' },
              { icon: PenTool, title: 'Logo Design', desc: 'Powerful and memorable logos crafted for long-term brand value.' },
              { icon: ImageIcon, title: 'Social Media Graphics', desc: 'Creatives that boost engagement and strengthen brand presence.' },
              { icon: Brush, title: 'Custom Illustrations', desc: 'Unique artwork and vector illustrations built for your needs.' },
              { icon: Layers, title: 'Print Media Design', desc: 'Flyers, brochures, business cards, menus & packaging designs.' },
              { icon: Sparkles, title: 'Ad Creatives', desc: 'High-impact visuals optimized for advertising platforms.' },
      ...
      <section className="py-20 bg-gradient-to-b from-white to-sky-50">
        <div className="container px-6 xl:px-16 grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="text-4xl font-bold mb-6 text-sky-800">Designs That Leave an Impression</h2>
            <p className="text-lg text-gray-600 mb-4 leading-relaxed">
              Our creative process focuses on clarity, branding consistency, and visual impact. Every design is crafted to connect emotionally with your target audience.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
              Whether digital or print, our designs help you communicate your message confidently and professionally.
            </p>
          </motion.div>
      ...
      <section className="py-24 bg-gradient-to-r from-sky-600 via-blue-600 to-sky-700 text-white text-center relative overflow-hidden">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-6 drop-shadow-lg">
            Need Stunning Graphic Designs?
          </h2>
          <p className="text-lg md:text-xl text-blue-100 mb-10">
            Let’s build visuals that elevate your brand and captivate your audience.
          </p>
