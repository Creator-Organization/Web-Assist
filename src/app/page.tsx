...
export default function HomePage() {
  return (
    <main className="min-h-screen">
      ...
      <section className="relative bg-primary-600 text-white py-24 md:py-32 overflow-hidden">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6 xl:px-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            <Link href="/digital-marketing" className="group bg-white rounded-xl shadow-md p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3 group-hover:text-primary-600 transition-colors">Digital Marketing</h3>
              <p className="text-gray-600 mb-6 leading-relaxed">Boost your online visibility with SEO, SEM, and strategic content marketing</p>
            ...
            <Link href="/web-services" className="group bg-white rounded-xl shadow-md p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100">
              <div className="w-14 h-14 bg-gradient-to-br from-primary-100 to-primary-200 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <svg className="w-7 h-7 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-3 group-hover:text-primary-600 transition-colors">Web Services</h3>
              <p className="text-gray-600 mb-6 leading-relaxed">Beautiful, responsive websites that convert visitors into customers</p>
              <span className="text-primary-600 font-semibold inline-flex items-center gap-2">
                Explore Services
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </span>
            ...
            <Link href="/cms-development" className="group bg-white rounded-xl shadow-md p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100">
              <div className="w-14 h-14 bg-gradient-to-br from-primary-100 to-primary-200 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <svg className="w-7 h-7 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-3 group-hover:text-primary-600 transition-colors">CMS Development</h3>
              <p className="text-gray-600 mb-6 leading-relaxed">WordPress, Joomla, Drupal platforms customized for your needs</p>
              <span className="text-primary-600 font-semibold inline-flex items-center gap-2">
                Explore Services
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </span>
            ...
            <Link href="/software-development" className="group bg-white rounded-xl shadow-md p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100">
              <div className="w-14 h-14 bg-gradient-to-br from-primary-100 to-primary-200 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <svg className="w-7 h-7 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-3 group-hover:text-primary-600 transition-colors">Software Development</h3>
              <p className="text-gray-600 mb-6 leading-relaxed">Custom software and mobile apps for iOS and Android platforms</p>
              <span className="text-primary-600 font-semibold inline-flex items-center gap-2">
                Explore Services
                <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </span>
        ...
        <div className="container mx-auto px-6 xl:px-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <div key={i} className="flex items-start space-x-4 p-6 rounded-xl hover:bg-gray-50 transition-colors">
      ...
      <section className="py-20 bg-gradient-to-br from-primary-600 to-primary-700 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 xl:px-16 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-teal-100 text-lg">Delivering results that matter</p>
          </div>
          
          <div className="grid md:grid-cols-4 gap-8 max-w-5xl mx-auto">
            <div className="text-center p-6 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
              <div className="text-5xl md:text-6xl font-bold mb-2">500+</div>
              <div className="text-teal-100 text-lg">Projects Completed</div>
            </div>
            <div className="text-center p-6 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
            ...
            <div className="text-center p-6 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
              ...
              <div className="text-teal-100 text-lg">Years Experience</div>
            </div>
            <div className="text-center p-6 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
              <div className="text-5xl md:text-6xl font-bold mb-2">50+</div>
              <div className="text-teal-100 text-lg">Expert Team</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-primary-600 to-primary-700 text-white">
        <div className="container mx-auto px-6 xl:px-16 text-center">
          ...
          <p className="text-teal-100 mt-6 text-sm">Free consultation • No commitment required • Response within 24 hours</p>
        </div>
      </section>
    </main>
  );
