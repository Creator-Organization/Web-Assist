...
export default function HomePage() {
  ...
  const featuredInternships = [
    { title: "Software Engineer Intern", company: "Innovate Inc.", location: "Remote" },
    { title: "Marketing Intern", company: "Growth Co.", location: "New York, NY" },
    { title: "Product Design Intern", company: "Designs LLC", location: "San Francisco, CA" },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <section id="features" className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center mb-12">Why InternshipHub?</h2>
